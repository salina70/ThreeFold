...
- **M**ongoDB + Mongoose
- **E**xpress
- **R**eact (Create React App, React Router)
- **N**ode.js
- Custom-built lexicon-based NLP engine (`backend/utils/sentiment.js`) for sentiment scoring and keyword extraction — no OpenAI/external API key needed, so it runs anywhere with no setup friction.
