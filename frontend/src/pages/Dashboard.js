...
export default function Dashboard() {
  ...
  if (!data)
    return (
      <div className="fn-page">
        <p className="fn-muted">Crunching the numbers...</p>
      </div>
    );
  ...
  return (
    <div className="fn-page">
      <Link to={`/business/${business._id}`} className="fn-link-quiet">
        &larr; Back to {business.name}
      </Link>
      <h1>AI insights for {business.name}</h1>
      <p className="fn-muted">
        Generated automatically from every review's rating, sentiment, and
        keywords.
      </p>
      ...
      <section className="fn-stat-row">
        ...
        <div className="fn-stat-card">
          <span className="fn-stat-value">
            {Math.round((sentimentSummary.positive / sentimentTotal) * 100)}%
          </span>
            ...
            <div className="fn-bar-row" key={row.key}>
              ...
              <div className="fn-bar-track">
                <div
                  ...
                  style={{
                    width: `${(sentimentSummary[row.key] / sentimentTotal) * 100}%`,
            ...
            <div className="fn-bar-row" key={star}>
              ...
              <div className="fn-bar-track">
                <div
                  className="fn-bar-fill"
                  style={{
                    width: `${(ratingBreakdown[star] / ratingMax) * 100}%`,
      ...
      <section className="fn-panel">
        ...
        {topKeywords.length === 0 && (
          <p className="fn-muted">
            Not enough reviews yet to surface keywords.
          </p>
        )}
        ...
        <section className="fn-panel">
          ...
          <div className="fn-trend-row">
            {recentTrend.map((t, i) => (
              <div
                key={i}
                className={`fn-trend-dot fn-trend-${t.label}`}
                title={`${t.label} (rating ${t.rating})`}
              />
            ))}
          </div>
